...
class JellyRancherHelpDialog(QDialog):
    ...
    def create_faq_tab(self):
        ...
        <p>Semantic memory allows you to search through all project documentation and context using natural language queries. It's powered by ChromaDB and helps you find relevant information quickly.</p>
